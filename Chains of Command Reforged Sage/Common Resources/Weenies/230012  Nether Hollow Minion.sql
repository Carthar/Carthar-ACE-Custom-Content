...
VALUES (230012, '230012 Weak Nether Hollow Minion', 10, '2026-08-05 04:45:30') /* Creature */;
...
VALUES (230012,   1,       5) /* HeartbeatInterval */
     ...
     , (230012,  15,    0.86) /* ArmorModVsBludgeon */
     , (230012,  16,    0.84) /* ArmorModVsCold */
     , (230012,  17,       5) /* ArmorModVsFire */
     , (230012,  18,       3) /* ArmorModVsAcid */
     , (230012,  19,       2) /* ArmorModVsElectric */
     ...
     , (230012,  68,    0.75) /* ResistCold */
     , (230012,  69,    0.55) /* ResistAcid */
...
VALUES (230012,  0,  4,  0,    0,  470,  235,  235,  235,  235,  235,  235,  235,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head - Bludgeon */
     , (230012,  1,  4,  0,    0,  470,  235,  235,  235,  235,  235,  235,  235,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest - Bludgeon */
     , (230012,  2,  4,  0,    0,  470,  235,  235,  235,  235,  235,  235,  235,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen - Bludgeon */
     , (230012,  3,  4,  0,    0,  450,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm - Bludgeon */
     , (230012,  4,  4,  0,    0,  450,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm - Bludgeon */
     , (230012,  5,1024, 80, 0.25,  450,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand - Nether */
     , (230012, 17,  4,  0,    0,  450,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail - Bludgeon */;
