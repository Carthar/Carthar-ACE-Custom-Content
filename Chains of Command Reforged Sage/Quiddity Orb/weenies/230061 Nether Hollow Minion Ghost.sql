...
VALUES (230061, '230061 Nether Hollow Minion Ghost', 10, '2026-08-07 11:23:09') /* Creature */;
...
VALUES (230061,   1,         16) /* ItemType - Creature */
     ...
     , (230061, 307,         50) /* DamageRating */
     , (230061, 308,         50) /* DamageResistRating */
     , (230061, 386,         25) /* Overpower */;
...
VALUES (230061,   1,       5) /* HeartbeatInterval */
     ...
     , (230061,  15,    0.86) /* ArmorModVsBludgeon */
     , (230061,  16,    0.84) /* ArmorModVsCold */
     , (230061,  17,       5) /* ArmorModVsFire */
     , (230061,  18,       3) /* ArmorModVsAcid */
     , (230061,  19,       2) /* ArmorModVsElectric */
     ...
     , (230061,  68,    0.75) /* ResistCold */
     , (230061,  69,    0.55) /* ResistAcid */
...
VALUES (230061,  0,  4,  0,    0,  470,  235,  235,  235,  235,  235,  235,  235,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head - Bludgeon */
     , (230061,  1,  4,  0,    0,  470,  235,  235,  235,  235,  235,  235,  235,    0, 2, 0.44, 0.23,    0, 0.44, 0.23,    0, 0.44, 0.17,    0, 0.44, 0.17,    0) /* Chest - Bludgeon */
     , (230061,  2,  4,  0,    0,  470,  235,  235,  235,  235,  235,  235,  235,    0, 3,    0, 0.23,  0.1,    0, 0.23,  0.2,    0, 0.17, 0.45,    0, 0.17, 0.45) /* Abdomen - Bludgeon */
     , (230061,  3,  4,  0,    0,  450,  225,  225,  225,  225,  225,  225,  225,    0, 1, 0.23, 0.04,  0.2, 0.23, 0.04,  0.1, 0.23, 0.03,    0, 0.23, 0.03,    0) /* UpperArm - Bludgeon */
     , (230061,  4,  4,  0,    0,  450,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.3,  0.3,    0,  0.3,  0.4,    0,  0.3,  0.1,    0,  0.3,  0.1) /* LowerArm - Bludgeon */
     , (230061,  5,1024,280, 0.25,  450,  225,  225,  225,  225,  225,  225,  225,    0, 2,    0,  0.2,  0.3,    0,  0.2,  0.2,    0,  0.2,    0,    0,  0.2,    0) /* Hand - Nether */
     , (230061, 17,  4,  0,    0,  450,  225,  225,  225,  225,  225,  225,  225,    0, 3,    0,    0,  0.1,    0,    0,  0.1,    0, 0.13, 0.45,    0, 0.13, 0.45) /* Tail - Bludgeon */;
